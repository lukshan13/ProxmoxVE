...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/lukshan13/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/lukshan13/ProxmoxVE/main/ct/myapp.sh)"
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/lukshan13/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/lukshan13/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/lukshan13/ProxmoxVE/discussions)

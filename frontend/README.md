...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/lukshan13/ProxmoxVE.git
...
- **[Community Scripts Repository](https://github.com/lukshan13/ProxmoxVE)**
- **[Discord Community](https://discord.gg/3AnUqsXnmK)**
- **[GitHub Discussions](https://github.com/lukshan13/ProxmoxVE/discussions)**
...
- **📝 Change Log**: [https://github.com/lukshan13/ProxmoxVE/blob/main/CHANGELOG.md](https://github.com/lukshan13/ProxmoxVE/blob/main/CHANGELOG.md)
